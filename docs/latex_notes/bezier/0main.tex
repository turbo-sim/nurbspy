...
\begin{center}
{\LARGE \bf A briefing on \Bezier curves and surfaces}\\
\vspace{2ex}
{\large Roberto Agromayor, \today }\\
\end{center}

This note introduces \Bezier curves and surfaces and summarizes their most important mathematical properties. Most of the material used to prepare this note is available in the NURBS book \parencite[Chapter 1]{NURBS_book}.

\input{Bezier_curves}
\clearpage

\input{Bezier_surfaces}
