...
\begin{center}
{\LARGE \bf A briefing on B-Spline curves and surfaces}\\
\vspace{2ex}
{\large Roberto Agromayor, \today }\\
\end{center}

This note introduces B-Spline curves and surfaces and summarizes their most important mathematical properties. Most of the material used to prepare this note is available in the NURBS book \parencite[Chapters 2 and 3]{NURBS_book}.

\input{BSpline_curves}
\clearpage

\input{BSpline_surfaces}
